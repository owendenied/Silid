    ...
    <div className="flex flex-col min-h-screen">
      <header className="flex justify-between items-center p-6 bg-white shadow-sm border-b border-gray-200">
        ...
        <div className="flex gap-4">
          <Link to="/login" className="px-4 py-2 font-medium text-[var(--color-silid-teal)] hover:bg-gray-50 rounded-md transition-colors">
            Mag-sign In
          </Link>
          <Link to="/login" className="px-4 py-2 font-medium text-white bg-[var(--color-silid-teal)] hover:bg-blue-800 rounded-md transition-colors shadow-sm">
            Magsimula (Libre)
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1">
        <section className="px-6 py-20 text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/login" className="px-8 py-4 text-lg font-bold text-white bg-[var(--color-silid-yellow)] hover:bg-yellow-600 rounded-lg shadow-md transition-transform hover:scale-105">
              Gumawa ng Account
            </Link>
            <Link to="/demo" className="px-8 py-4 text-lg font-bold text-[var(--color-silid-teal)] bg-white border-2 border-[var(--color-silid-teal)] hover:bg-blue-50 rounded-lg shadow-sm transition-transform hover:scale-105">
              Subukan ang Demo
            </Link>
          </div>
        </section>
        ...
        <section className="bg-gray-50 py-16 px-6">
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-blue-100 text-[var(--color-silid-teal)] rounded-full flex items-center justify-center mb-6">
                <Users size={32} />
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-yellow-100 text-[var(--color-silid-yellow)] rounded-full flex items-center justify-center mb-6">
                <WifiOff size={32} />
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-green-100 text-[var(--color-silid-green)] rounded-full flex items-center justify-center mb-6">
                <BookOpen size={32} />
              </div>
